...
export const SignIn = () => {
    return (
        ...
        <form>
            ...
            <div className="box" id="slogin">
                <label className="label" for="cname"><b>Company Name</b></label>
                <input className= "input" type="text" placeholder="Enter Company Name" name="cname" required></input>
                
                <label className="label" for="pswd"><b>Password</b></label>
                <input className= "input" type="password" placeholder="Enter Password" name="pswd" required></input>
                
                <button className="button" type="submit">Login</button>
                
                <button className="button" type="">View Membership Prices</button>
            </div>
        </form>
    </section>
    )
